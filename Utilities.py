...
class ParkingLot:
    ...
    def set_slots(self, slot, value):
        ...
        ARGS:
            ...
            value(Nonetype or Car object)
            -
            for setting the value on the given slot
        """
...
def park_car(parkingLot, registrationNumber, colour):
    """
    will park the car in the
    parking lot and prints the 
    allocated slot in the parking lot
    ARGS:
        parkingLot(ParkingLot Object)
